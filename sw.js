...
const VERSION = 'coco-v2';
const SHELL = ['./', './index.html', './css/app.css', './js/app.js', './js/store.js', './js/notation.js', './js/audio/engine.js',
  './js/labs/groove.js', './js/labs/melody.js', './js/labs/chords.js', './js/theory.js', './js/midi.js', './js/tts.js', './data/staffs.js', './data/toc.js', './vendor/vexflow.js', './manifest.json', './assets/icon.svg',
